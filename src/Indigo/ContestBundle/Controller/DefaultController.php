...
class DefaultController extends Controller
{
    ...
    public function indexAction(Request $request)
    {
        ...
        $form = $this->createFormBuilder($data)
                ->add('contest_title', 'text', ['attr' => ['placeholder' => $this->st('create_contest.form.contest_title')], 'label' => false])
                ->add('image', 'file', ['label' => false])
                ...
                ->add('contest_type', 'choice',
                        ...
                        'required' => true])
                ->add('table_name', 'text', ['attr' => ['placeholder' => $this->st('create_contest.form.table_name')], 'label' => false])
                ->add('table_name', 'text', ['attr' => ['placeholder' => $this->st('create_contest.form.table_name')], 'label' => false])
                ->add('save', 'submit', ['attr' => ['placeholder' => $this->st('create_contest.form.submit')], 'label' => false])
                ->getForm();
        ...
        if($request->isMethod("POST")){
            ...
            $return_data = $this->render('IndigoContestBundle:Default:index.html.twig',
                array('contest_form' => $form->createView(), 'image_name' => 'contest_logo.jpg'
                ));
        }
